...
def calculate_mordred_descriptors(molecules, desc=None, ignore_3d=True, num_workers=1): # TODO: check num_workers
...
class MordredMolecularFeaturizer(MolecularFeaturizer):
    ...
    def calculate_descriptors(self, data):
        ...
        descriptors = calculate_mordred_descriptors(rd_mols, self.desc, self.ignore_3d, num_workers=self.nproc)
